...
import { TgetUrl, TgetUrlPNGProps, TgetUrlParams, TgetUrlSVGProps } from '@locTypes/helpers/getUrl';

import { getDownloadURL, ref } from 'firebase/storage';

export default ({ imageName, imageType, sourseMod, svg }: TgetUrlPNGProps | TgetUrlSVGProps) => {
